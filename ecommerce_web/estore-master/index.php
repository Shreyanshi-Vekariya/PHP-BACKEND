...
<html class="no-js" lang="zxx">
   ...
   <body>
                                ...
                                <ul class="header-right f-right d-none d-lg-block d-flex justify-content-between">
                                    ...
                                    <form action="search.php" method="GET">
                                        <div class="form-box f-right ">
                                            ...
                                            <input type="text" name="search" id = "search" placeholder="Search products" onkeyup="searchFun()">
    ...
    <main>
        ...
        $query = mysqli_query($con, "select * from product where c_name = 'men'");
        while($row = mysqli_fetch_array($query))
        {

        ?>
                            <div class="col-xl-4 col-lg-4 col-md-6">
                                <div class="single-product mb-100" style = "border-radius:10px; box-shadow: 0 0 20px black;">
                                    <div class="product-img " style= "height:300px; width:250px; margin : auto; ">
                                        <img  src="../admin_panel/<?php echo htmlentities($row['p_img']);?>" alt="">
                                    ...
                                    <div class="product-caption">
                                        ...
                                        <h4><a href="single-product.php?pid=<?php echo $row['p_id'];?>"><?php echo htmlentities($row['p_description']); ?></a></h4>
                                        <div class="price">
                                            <ul>
                            ...
                            $query = mysqli_query($con, "select * from product where c_name = 'women'");
        while($row = mysqli_fetch_array($query))
        {
...
$query = mysqli_query($con, "select * from product where c_name = 'kids'");
while($row = mysqli_fetch_array($query))
{
...
$query = mysqli_query($con, "select * from product where c_name = 'accessories'");
while($row = mysqli_fetch_array($query))
{

?>
<div class="col-xl-4 col-lg-4 col-md-6">
    <div class="single-product mb-100" style="justify-content:center;
     border-radius:10px; box-shadow: 0 0 20px black;">
        <div class="product-img" style= " height:250px; width:200px; margin:auto; ">
            <img src="../admin_panel/<?php echo htmlentities($row['p_img']);?>" alt="">
            <div class="new-product">
                <span>New</span>
            </div>
...
<?php } ?>
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>                   </div>
	...
	<!-- JS here -->
        ...
        <script>
            const searchFun = () =>{
                let filter  = document.getElementById('').value.toUpperCase();
            }
        </script>
